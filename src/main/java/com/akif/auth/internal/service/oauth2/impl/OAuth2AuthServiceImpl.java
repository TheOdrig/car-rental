package com.akif.auth.internal.service.oauth2.impl;

import com.akif.auth.internal.config.OAuth2Properties;
...
import com.akif.auth.internal.exceptipn.AccountAlreadyLinkedException;
...
import com.akif.auth.internal.repository.LinkedAccountRepository;
...
import com.akif.auth.internal.service.oauth2.OAuth2ProviderService;
...
public class OAuth2AuthServiceImpl implements OAuth2AuthService {
    ...
    public OAuth2AuthServiceImpl(
            ...
            List<OAuth2ProviderService> providerServiceList) {
    ...
    private OAuth2ProviderService getProviderService(String provider) {
        OAuth2ProviderService service = providerServices.get(provider.toLowerCase());
        if (service == null) {
